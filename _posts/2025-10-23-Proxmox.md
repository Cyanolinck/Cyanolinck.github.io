...
# This is an Proxmoix setup guide with how I personally run Proxmox.
...
![alt text](../_site/assets/Images/rufus-select.png)
...
![alt text](../_site/assets/Images/rufus-dd.png)
...
![alt text](../_site/assets/Images/rufus-ready.png)

&nbsp;

Detach the USB and boot the computer from the USB drive.

Follow below images or go to https://pve.proxmox.com/wiki/Installation for a more thorogh walkthough of the setup options.


![alt text](../_site/assets/Images/image.png)

![alt text](../_site/assets/Images/image-4.png)

&nbsp;

Select the drive where Proxmox should be installed on. We'll leave the rest as default.

![alt text](../_site/assets/Images/image-1.png)

&nbsp;

If the computer is connected to a network with DHCP if will give itself an IP, Note that this will be set statically on the computer so if the IP get's reserverd by anohter computer in the future it will fail to get an IP address. So reserve the IP assiged to proxmox so you won't get any conflicts in the future.


If you will be using Tailscale you can use your Tailnet DNS name.
For example, mine is spotted-universe.ts.net and I want this proxmox machine to be named Proxmox-guide.

![alt text](../_site/assets/Images/image-16.png)

So I'll use **proxmox-guide.spotted-universe.ts.net**

If you also want to use Tailscale follow below.

Sign up for tailscale and once in, go to the DNS option.
...
![alt text](../_site/assets/Images/image-2.png)

![alt text](../_site/assets/Images/image-19.png)
...
![alt text](../_site/assets/Images/image-5.png)
...
![alt text](../_site/assets/Images/image-17.png)
...
![alt text](../_site/assets/Images/image-6.png)
...
![alt text](../_site/assets/Images/image-7.png)
...
![alt text](../_site/assets/Images/image-8.png)
...
![alt text](../_site/assets/Images/image-10.png)
...
![alt text](../_site/assets/Images/image-11.png)
...
![alt text](../_site/assets/Images/image-18.png)


![alt text](../_site/assets/Images/image-9.png)

![alt text](../_site/assets/Images/image-12.png)

![alt text](../_site/assets/Images/image-13.png)

![alt text](../_site/assets/Images/image-14.png)

![alt text](../_site/assets/Images/image-15.png)
