...
![alt text]({{ site.baseurl }}assets/Images/rufus-select.png)

![Rufus Select]({{ '/assets/Images/rufus-select.png' | relative_url }})
...
![alt text](assets/Images/rufus-dd.png)
...
![alt text](assets/Images/rufus-ready.png)
